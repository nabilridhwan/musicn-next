        ...
        <Stack gap={10}>
          ...
          <FormControl>
            <HStack justifyContent={'space-between'} alignItems={'center'}>
              <Stack>
                <FormLabel m={0}>Recently Played Songs</FormLabel>

                <FormHelperText m={0}>
                  When enabled, your recently played songs are visible to other
                  users.
                </FormHelperText>
              </Stack>
          ...
          <FormControl>
            <HStack justifyContent={'space-between'} alignItems={'center'}>
              <Stack>
                <FormLabel m={0}>Top Songs</FormLabel>
          ...
          <FormControl>
            <HStack justifyContent={'space-between'} alignItems={'center'}>
              <Stack>
                <FormLabel m={0}>Currently Playing Track</FormLabel>

                <FormHelperText m={0}>
                  When enabled, your currently playing track is visible to other
                  users.
                </FormHelperText>
              </Stack>
          ...
          <FormControl>
            <HStack justifyContent={'space-between'} alignItems={'center'}>
              <Stack>
                <FormLabel m={0}>Account</FormLabel>
          ...
          {hasPreferences && (
            <Text color={'gray.500'} fontSize={'sm'}>
              Last updated:{' '}
              {DateTime.fromISO(
                userFromProps.preferences.updated_at,
              ).toRelative()}
            </Text>
          )}
