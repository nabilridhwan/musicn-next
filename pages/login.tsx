...
const validationSchema = yup.object().shape({
    username: yup.string().email("Please type in a valid email").required('Email is required'),
...
const LoginPage = () => {
    ...
    const {isValid, dirty, values, setFieldValue, errors, isSubmitting, handleSubmit} = useFormik<typeof initialValues>({
        validationSchema,
        initialValues,
