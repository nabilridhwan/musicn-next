...
const validationSchema = yup.object().shape({
    ...
    password: yup.string().required('Password is required').oneOf([yup.ref('confirm_password')], 'Passwords must match'),
...
const SignupPage = () => {
    ...
    async function handleSignUp(values: typeof initialValues) {
        ...
        if(parseUsername(values.username).length === 0) {
            setFieldError('username', 'Username can only start with a letter and contain letters, numbers, underscores, and dashes.');
            return;
        }
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <Stack>
                            <Button
                                ...
                                isDisabled={!dirty || !isValid || isSubmitting} type={"submit"} data-test-id={'signup-button'}>
                                Sign Up
                            </Button>
